...
def dreamplace_interface(
    params,
    placedb,
    run_place=True,
):
    """
    DREAMPlace external interface.

    The input placedb should already be converted and initialized outside.
    ...
    Args:
        ...
        run_place:
            If False, only return placedb for checking.
            If True, run DREAMPlace optimization.

    Returns:
        placedb or optimization result.
    """
    params.printWelcome()
    ...
    # Make sure PlaceDB has been initialized.
    # If the outer script already called placedb(params), this call can be skipped.
    # But calling it once here is usually safe before placement
    
    # todo return macro position
